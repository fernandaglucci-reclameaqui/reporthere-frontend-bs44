...
export default function ClaimCompany() {
  ...
  }, [companyId, loadData]); // Add loadData to the dependency array
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (emailDomain && companyDomain && emailDomain === companyDomain && company.verified_status !== 'verified') {
        ...
        const existingMember = await CompanyMember.filter({
          company_id: companyId,
          user_id: user.id
        });
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Claim Company Profile</h1>
          <p className="text-gray-600">
            Verify that you represent this business to respond to complaints and manage your reputation.
          </p>
        </div>
        ...
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">
              Complete the form below to claim this business profile
            </p>
          </CardHeader>
